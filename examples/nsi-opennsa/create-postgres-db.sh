psql postgres <<EOF
CREATE DATABASE "opennsa" WITH OWNER "nsi-node-user";
EOF
psql opennsa <<EOF
...
ALTER TYPE label OWNER TO "nsi-node-user";
ALTER TYPE parameter OWNER TO "nsi-node-user";
ALTER TYPE security_attribute OWNER TO "nsi-node-user";
ALTER TYPE directionality OWNER TO "nsi-node-user";
ALTER TABLE service_connections OWNER TO "nsi-node-user";
ALTER TABLE sub_connections OWNER TO "nsi-node-user";
ALTER TABLE generic_backend_connections OWNER TO "nsi-node-user";
ALTER TABLE backend_connection_id OWNER TO "nsi-node-user";
EOF
